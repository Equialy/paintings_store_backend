...
class AuthServiceImpl:
    ...
    def encode_jwt(
        self, payload: dict, expire_timedelta: timedelta | None = None
    ) -> str:
        return self.jwt_service.encode_jwt(
            payload=payload, expire_timedelta=expire_timedelta
        )
    ...
    async def validate_auth_user(
        ...
        if not user or not self.password_service.validate_password(
