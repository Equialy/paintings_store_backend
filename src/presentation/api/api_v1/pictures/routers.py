...
from src.presentation.dependencies.pictures.services import (
    PicturesService,
    PaginationDep,
)
...
async def get_picture_by_id(
    picture_id: int, picture_service: PicturesService
) -> PictureReadSchema:
...
async def list_pictures(
    service: PictureService, pagination: PaginationDep
